<nav class="bg-white border-gray-200 px-12 sm:px-4 py-2.5">
    <div class="container flex flex-wrap items-center justify-between mx-auto">
        <a href="{{ route('home') }}" class="flex items-center">
            <img src="{{ asset('img/nawatech.png') }}" class="h-6 mr-3 sm:h-9" alt="Nawa Pay" />
        </a>
        <div class="flex items-center">
            ...
            {{-- <a href="{{ route('logout') }}" --}}
            <a href=""
                class="rounded bg-primary-7 border border-primary-3 ml-8 px-2 py-1 text-sm text-primary-1 font-semibold hover:bg-primary-1 hover:text-white"><i
