    ...
    <div class="container flex flex-wrap items-center justify-between mx-auto">
        <a href="{{ route('home') }}" class="flex items-center">
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/Logo_Kasir_Pintar.png/799px-Logo_Kasir_Pintar.png"
                class="h-6 mr-3 sm:h-9" alt="Kasir Pintar" />
        </a>
        <div class="flex items-center">
            <div class="block w-auto mt-2">
                ...
                <div
                    ...
                    <div class="p-3 flex justify-between">
                        ...
                        <a href="" class="text-gray-900 hover:text-primary-1 text-sm py-1">See
                            All</a>
                    </div>
            ...
            <form method="POST" action="{{ route('logout') }}" class="ml-8">
                @csrf
                <button type="submit"
                    class="rounded bg-white border border-primary-3 px-2 py-1 text-sm text-black font-semibold hover:bg-red-500 hover:text-white">
