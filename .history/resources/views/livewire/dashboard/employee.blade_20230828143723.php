                                ...
                                <div x-cloak x-show="modalOpen_1"
                                    ...
                                    <form wire:submit.prevent="submit">
                                        ...
                                        <div class="flex justify-between mt-6 space-x-4">
                                            ...
                                            <button type="submit" @click="modalOpen_1 = false"
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <button
                                                    ...
                                                    onclick="actionReimbursement({{ $employee->id }})">Update</button>
                                                <button
                                                    class="px-4 py-2 text-sm bg-red-500 text-white rounded hover:bg-red-600 ml-2"
                                                    onclick="actionReimbursement({{ $employee->id }})">Delete</button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
...
<script>
    function updateEemployee(id, string) {
        console.log(id, string)
        // Livewire.emit('getDetail', id);
    }

    function deleteeEmployee(id, string) {
        console.log(id, string)
        // Livewire.emit('getDetail', id);
    }
