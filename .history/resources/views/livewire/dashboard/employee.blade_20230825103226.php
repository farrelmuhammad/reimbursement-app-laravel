                        ...
                        <div x-show="modalOpen_1" class="fixed inset-0 z-50 overflow-y-auto"
                            ...
                            <div
                                ...
                                <div x-cloak x-show="modalOpen_1"
                                    ...
                                    <div class="mt-6">
                                        <label for="nip_employeee" class="block text-sm font-medium text-gray-700">NIP
                                            Karyawan</label>
                                        <input type="text" id="nip_employeee" name="nip_employeee"
                                            wire:model="nip_employeee"
                                    ...
                                    <div class="mt-6">
                                        <label for="employee_name" class="block text-sm font-medium text-gray-700">Nama
                                            Karyawan</label>
