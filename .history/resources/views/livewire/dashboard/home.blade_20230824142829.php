                        ...
                        <div
                            ...
                            <div x-cloak x-show="modalOpen_2"
                                ...
                                <a wire:click="signAgreement" @click="modalOpen_2 = false"
                                    class="bg-green-500 text-white active:bg-primary-3 text-sm font-bold px-6 py-3 rounded-lg shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 mt-20 w-full ease-linear transition-all duration-150 text-center cursor-pointer"
                                    type="button">
                                    Sign Agreement
                                </a>
                            </div>
