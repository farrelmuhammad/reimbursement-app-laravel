                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                @if ($reimbursement->status === 'pending')
                                                    <span
                                                        class="inline-block rounded bg-yellow-400 px-2 py-1 text-white text-xs font-semibold">
                                                        {{ $reimbursement->status }}
                                                    </span>
                                                @elseif ($reimbursement->status === 'approve')
                                                    <span
                                                        class="inline-block rounded bg-green-400 px-2 py-1 text-white text-xs font-semibold">
                                                        {{ $reimbursement->status }}
                                                    </span>
                                                @elseif ($reimbursement->status === 'reject')
                                                    <span
                                                        class="inline-block rounded bg-red-400 px-2 py-1 text-white text-xs font-semibold">
                                                        {{ $reimbursement->status }}
                                                    </span>
                                                @endif
                                            </td>
