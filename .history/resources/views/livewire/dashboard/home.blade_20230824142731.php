    ...
    <div class="flex p-10">
        ...
        <div class="ml-10 w-full">
            ...
            <div class="bg-white rounded-lg p-6 my-5 w-full">
                ...
                <div x-data="{ modalOpen_2: true, modalOpen_3: false }" class="h-[363px] w-[560px] mt-4">
                    <div x-show="modalOpen_2" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title"
                        ...
                        <div
                            ...
                            <div x-cloak x-show="modalOpen_2"
                                ...
                                <h1 class="text-xl font-bold">Sign Agreement</h1>
                                <p class="mt-10 text-gray-600">Click button sign agreement and you'll enjoy access to
                                    our
                                    apps, plus other benefits, with this agreement you will enjoy all the benefits in
                                    nawapay.</p>
                                <a wire:click="signAgreement" @click="modalOpen_2 = false"
                                    class="bg-primary-1 text-white active:bg-primary-3 text-sm font-bold px-6 py-3 rounded-lg shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 mt-20 w-full ease-linear transition-all duration-150 text-center cursor-pointer"
                                    type="button">
                                    Sign Agreement
                                </a>
                            </div>
