    ...
    <div class="flex p-10">
        ...
        <div class="ml-10 w-full">
            ...
            <div class="bg-white rounded-lg p-6 my-5 w-full">
                ...
                <div x-show="modalOpen_1" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title"
                    ...
                    <div
                        ...
                        <div x-cloak x-show="modalOpen_1"
                            ...
                            <div class="flex items-center justify-between space-x-4">
                                <h1 class="text-xl font-medium text-gray-900 ">Payment Detail</h1>
                            ...
                            <div class="flex justify-between">
                                <span class="text-gray-900 text-xs mt-4">Installment to</span>
                                <div class="flex justify-between">
                                    <span
                                        class="bg-primary-7 text-primary-1 border border-primary-1 px-3 py-2 rounded-lg text-md font-bold">{{ $startPeriod }}</span>
                                    <span class="text-md font-bold p-2">/</span>
                                    <span
                                        class="bg-primary-7 text-primary-1 border border-primary-1 px-3 py-2 rounded-lg text-md font-bold">{{ $endPeriod }}</span>
                                </div>
                            </div>
