    ...
    <div class="flex p-10">
        ...
        <div class="ml-10 w-full">
            ...
            <div class="bg-white rounded-lg p-6 my-5 w-full">
                ...
                <div x-cloak x-show="modalOpen_2" x-transition:enter="transition ease-out duration-300 transform"
                    ...
                    <div class="flex mt-10 space-x-4">
                        ...
                        <a wire:click="signAgreement" onclick="closeModal()"
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($reimbursements as $index => $reimbursement)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <button class="px-4 py-2 text-sm bg-green-500 text-white rounded hover:bg-green-600"
...
<script>
    ...
    function openModal() {
        modalOpen_2 = true; // Membuka modal
    }

    function closeModal() {
        modalOpen_2 = false; // Menutup modal
    }
</script>
