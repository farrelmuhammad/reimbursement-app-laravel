                                                        ...
                                                        <div
                                                            ...
                                                            <div x-cloak x-show="modalOpen_2"
                                                                ...
                                                                @if ($selectedReimbursement)
                                                                    ...
                                                                    <p><strong>ID:</strong>
                                                                        {{ $selectedReimbursement['id'] }}</p>
                                                                    <p><strong>User ID:</strong>
                                                                        {{ $selectedReimbursement['user_id'] }}</p>
                                                                    <p><strong>Nama Reimbursement:</strong>
                                                                        {{ $selectedReimbursement['nama_reimbursement'] }}
                                                                    </p>
                                                                    <p><strong>Tanggal:</strong>
                                                                        {{ $selectedReimbursement['tanggal'] }}</p>
                                                                    <p><strong>Deskripsi:</strong>
                                                                        {{ $selectedReimbursement['deskripsi'] }}</p>
                                                                    <p><strong>Status:</strong>
                                                                        {{ $selectedReimbursement['status'] }}</p>
                                                                    <p><strong>File Pendukung:</strong>
                                                                        {{ $selectedReimbursement['file_pendukung'] }}
                                                                    </p>
                                                                    <!-- Add any other fields you included in the array -->
                                                                @else
