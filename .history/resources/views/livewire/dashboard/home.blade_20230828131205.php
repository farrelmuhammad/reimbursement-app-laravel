                                    ...
                                    @foreach ($reimbursements as $index => $reimbursement)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                ...
                                                <div x-data="{ modalOpenDetails: false }"
                                                    x-on:open-details-modal.window="modalOpenDetails = true">
                                                    <div x-show="modalOpenDetails"
                                                        ...
                                                        <div
                                                            ...
                                                            <div x-cloak x-show="modalOpen_2"
                                                                ...
                                                                @if ($selectedReimbursementId)
                                                                    @livewire('fetch-reimbursement-details', ['reimbursementId' => $selectedReimbursementId])
                                                                @endif
                                                                <div
