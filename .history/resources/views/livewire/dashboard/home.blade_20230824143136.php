        ...
        <div class="ml-10 w-full">
            ...
            <div class="bg-white rounded-lg p-6 my-5 w-full">
                <div class="flex justify-between items-center mb-2">
                    ...
                    <button  @click="modalOpen_2 = true" class="bg-orange-500 hover:bg-orange-600 text-white font-semibold py-2 px-4 rounded-lg">
                        <i class="fa-solid fa-plus mr-2"></i>
                        Ajukan Permohonan
                    </button>
                </div>
                <!-- Nama di sebelah kiri -->
                <div x-data="{ modalOpen_2: false, modalOpen_3: false }" class="h-[363px] w-[560px] mt-4">
