    ...
    <div class="bg-white text-gray-800 shadow-lg overflow-hidden relative flex h-[566px] w-[514px] rounded-lg">
        <div class="bg-white h-full w-full pt-6 pb-20 overflow-y-auto">
            <div class="flex justify-between mb-5 pb-3 shadow-lg px-6">
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/Logo_Kasir_Pintar.png/799px-Logo_Kasir_Pintar.png" alt="Kasir Pintar" class="w-28 h-8">
        ...
        <div class="bg-white absolute bottom-0 w-full mb-0">
            ...
            <div class="flex flex-grow items-center justify-center px-6 py-2">
                <button onclick="window.location.href='{{ route('register') }}'"
                    class="bg-transparent border border-orange-500 text-orange-500 active:bg-red-3 active:text-red-3 text-sm font-bold px-6 py-3 rounded-lg shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full ease-linear transition-all duration-150 text-center"
