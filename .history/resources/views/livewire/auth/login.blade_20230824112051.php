    ...
    <div class="bg-white text-gray-800 shadow-lg overflow-hidden relative flex h-[566px] w-[514px] rounded-lg">
        <div class="bg-white h-full w-full pt-6 pb-20 overflow-y-auto">
            <div class="flex justify-between mb-5 pb-3 shadow-lg px-6">
                <img src="{{ asset('img/nawatech.png') }}" alt="Nawatech" class="w-28 h-8">
            ...
            <div class="px-6 mt-12">
                <span class="text-xs font-light text-slate-500">Login to SG Pay Later</span>
            </div>
            <div class="relative mx-6 mt-3">
            ...
            <div class="flex justify-between px-6">
                ...
                <a href=""
                    class="text-slate-500 hover:text-primary-1 active:text-primary-3">
        ...
        <div class="bg-white absolute bottom-0 w-full mb-3">
            <div class="flex flex-grow items-center justify-center px-6 py-2" x-data="">
                <button onclick="login()"
                    class="bg-primary-1 text-white active:bg-primary-3 text-sm font-bold px-6 py-3 rounded-lg shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full ease-linear transition-all duration-150 text-center"
                    type="button"> Login </button>
            </div>
            <div class="flex flex-grow items-center justify-center px-6 my-6">
                <div class="inline-flex justify-center items-center w-full">
                    <hr class="w-full h-px border-0 bg-slate-500">
                    <span
                        class="absolute left-1/2 px-3 text-slate-500 bg-white -translate-x-1/2 text-xs font-light">Don't
                        have an account?</span>
                </div>
            </div>
            <div class="flex flex-grow items-center justify-center px-6 py-2">
                {{-- <button onclick="window.location.href='{{ route('register-step-1') }}'" --}}
                <button onclick=""
                    class="bg-primary-7 text-primary-1 active:bg-primary-3 text-sm font-bold px-6 py-3 rounded-lg shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full ease-linear transition-all duration-150 text-center"
