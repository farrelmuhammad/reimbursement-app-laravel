        ...
        <div class="bg-white h-full w-full pt-6 pb-20 overflow-y-auto">
            ...
            <div class="relative mx-6">
                <input type="number" wire:model="nama"
                    ...
                    placeholder=" " />
                <label for="floating_outlined"
                    class="absolute text-sm text-slate-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] rounded px-2 font-bold bg-white border-2 border-slate-100 peer-focus:px-2 peer-focus:text-slate-500 peer-placeholder-shown:bg-slate-100 peer-placeholder-shown:font-normal peer-placeholder-shown:scale-90 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:font-bold peer-focus:bg-white peer-focus:-translate-y-4 left-1">Nama Karyawan<span
                        class="text-red-500 ml-1">*</span></label>
            </div>
            <div class="mx-6 mb-3">
                @error('nama')
            ...
            <div class="relative mx-6">
                <input type="number" wire:model="jabatan"
                    class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-slate-900 bg-slate-100 rounded-lg appearance-none border-2 focus:outline-none focus:ring-0 focus:border-primary-3 peer"
                    placeholder=" " />
                <label for="floating_outlined"
            ...
            <div class="relative mx-6" x-data="{ show: true }">
                ...
                <label for="floating_outlined"
                    class="absolute text-sm text-slate-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] rounded px-2 font-bold bg-white border-2 border-slate-100 peer-focus:px-2 peer-focus:text-slate-500 peer-placeholder-shown:bg-slate-100 peer-placeholder-shown:font-normal peer-placeholder-shown:scale-90 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:font-bold peer-focus:bg-white peer-focus:-translate-y-4 left-1">Confirm Password<span
                        class="text-red-500 ml-1">*</span></label>
            </div>
            <div class="mx-6 mb-3">
