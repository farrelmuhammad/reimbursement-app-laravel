        ...
        <div class="bg-white h-full w-full pt-6 pb-20 overflow-y-auto">
            ...
            <div class="relative mx-6 mt-8">
                ...
                <label for="floating_outlined"
                    class="absolute text-sm text-slate-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] rounded px-2 font-bold bg-white border-2 border-slate-100 peer-focus:px-2 peer-focus:text-slate-500 peer-placeholder-shown:bg-slate-100 peer-placeholder-shown:font-normal peer-placeholder-shown:scale-90 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:font-bold peer-focus:bg-white peer-focus:-translate-y-4 left-1">NIP<span class="text-red-500 ml-1">*</span></label>
            </div>
            <div class="mx-6 mb-5">
                @error('nip')
