        ...
        <div class="bg-white absolute bottom-0 w-full mb-3">
            <div class="flex flex-grow items-center justify-center px-6 py-2" x-data="">
                <button onclick="login()"
                    class="bg-primary-1 text-white active:bg-red-3 text-sm font-bold px-6 py-3 rounded-lg shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full ease-linear transition-all duration-150 text-center"
