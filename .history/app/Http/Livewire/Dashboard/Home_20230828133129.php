...
class Home extends Component
{
    ...
    {
        $reimbursement = DB::table('reimbursements')->find($id);

        if ($reimbursement) {
            $this->selectedReimbursement = $reimbursement;
        } else {
            // Handle the case where the reimbursement is not found
            // For example, you could show an error message or log the issue.
        }
    }
