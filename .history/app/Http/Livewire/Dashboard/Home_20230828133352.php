...
class Home extends Component
{
    ...
    public $selectedReimbursement = null;
    ...
    {
        $selectedReimbursement = DB::table('reimbursements')->find($id);
        ...
        dd($this->selectedReimbursement);

        // You can also dd($this->selectedReimbursement) here if you want to debug

        // Emit event or take any other action if needed
    }
